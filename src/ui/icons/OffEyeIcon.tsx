...
interface OffEyeIconProps {
  cb: () => void
}

export const OffEyeIcon: FC<OffEyeIconProps> = ({cb}) => {
  return (
    <svg onClick={cb} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
      ...
      />
      <path d="M1 1L23 23" stroke="#122434" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
